...
a_title = 'Pythonista Coder'
a_company = 'Python Café'
a_location = LocationInfo(city='Montreal',
                          state='Quebec',
                          country='Canada')
...
a_contact_info = ContactInfo(contact='Ms. Joshua',
                             email='josh@python.org',
                             website='https://www.pcafe.org')
